<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/subscriptions">
        <icon name="subscriptions" class="mr-2 w-4 h-4" :class="isUrl('subscriptions') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('subscriptions') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Subscriptions</div>
      </Link>
    </div>
    <div class="mb-4">
